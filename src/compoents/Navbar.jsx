...
export const Navbar = () => {
    ...
    return (
        <nav className={cn("fixed w-full z-3 transition-all duration-300",
        isScrolled ? "py-3 bg-backgorund/80 backdrop-blur-md shadow-xs" : "py-5")}>

            <div className="container flex item-center justify-between" href="#">
                ...
                <div className={cn("fixed inset-0 bg-background/95 backdrop-blur-md z-40 flex flex-col items-center justify-center",
                    "tranasition-all duration-300 md:hidden",
